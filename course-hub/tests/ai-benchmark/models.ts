...
export const MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    available: false,
    tier: "ultra-cheap",
    notes: "1M context, ultra-cheap. Best value for high-volume Chinese content",
  },
  {
  ...
  // ────────── Tier 2: Budget (production candidates) ──────────
  {
    ...
    provider: "DashScope (Alibaba)",
    pricePerMInput: 0.40,
    pricePerMOutput: 2.40,
    envKey: "DASHSCOPE_API_KEY",
    baseURL: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1",
    modelId: "qwen3.5-plus",
    available: false,
    tier: "budget",
    notes: "Current CourseHub production model. MoE 17B active. Intl pricing (CN: $0.26/$1.56)",
  },
  {
    id: "qwen3.6-plus",
    name: "Qwen 3.6-Plus 🆕 (Apr 2)",
    provider: "DashScope (Alibaba)",
    pricePerMInput: 0.50,
    pricePerMOutput: 3.00,
    envKey: "DASHSCOPE_API_KEY",
    baseURL: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1",
    modelId: "qwen3.6-plus",
    available: false,
    tier: "budget",
    notes: "NEWEST Qwen (Apr 2, 2026). Agentic coding + deep reasoning + multimodal. 1M context",
  },
  {
    id: "deepseek-chat",
    name: "DeepSeek V3.2",
