    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">CourseHub</CardTitle>
          <CardDescription>AI-powered study companion</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {/* Status messages */}
          {message && (
            <p className="rounded-lg bg-success/10 p-3 text-center text-sm text-success">{message}</p>
          )}
          {error && (
