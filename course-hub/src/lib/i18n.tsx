...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "practice.generateErrRate": "Too many requests — try again in a moment",
    "practice.generateErrNone": "No course outline found. Set up your course first.",
    "practice.generateErrFail": "Generation failed. Please try again.",
    ...
    "settings.reviewRetention": "Spaced Repetition Target Recall",
    "settings.reviewRetentionDesc": "How well you should remember each card before it's considered learned. Lower = fewer reviews, slightly less recall.",
    ...
    "settings.passwordPlaceholder": "New password (min 6 characters)",
    "settings.semesterPlaceholder": "e.g. Fall 2026",
    "settings.modelNote": "Model selection is managed by the administrator.",
    "settings.aboutTitle": "About CourseHub",
    "settings.aboutVersion": "Version:",
    "settings.aboutStack": "Stack:",
    "settings.aboutAI": "AI Model:",
    "settings.aboutStorage": "Storage:",
    "settings.aboutDesc": "CourseHub turns your syllabus into a structured learning system — outlines, study tasks, practice questions, and mastery tracking. Built for students who want to study smarter, not harder.",
    ...
    "review.nextDueToday": "Next review due in {hours}h",
    "review.nextDueTomorrow": "Next review due tomorrow",
    "review.nextDueFuture": "Next review in {days} days",
    ...
    "review.scopeNoMatch": "No matching topics found. Try different wording.",
    "review.scopeError": "Failed to match scope. Please try again.",
    ...
    "practice.shuffle": "Shuffle questions",
    "practice.bookmarkFilter": "Show bookmarked only",
    "practice.noBookmarkedQuestions": "No bookmarked questions",
    "practice.noBookmarkedQuestionsDesc": "Bookmark questions while practising to create your own drill set.",
    ...
    "voiceNotes.step1Label": "1. Speak or paste the raw note",
    "voiceNotes.step1Desc": "Use the mic for the main note, then use the smaller mic buttons below if AI asks you to clarify something.",
    "voiceNotes.stopRecording": "Stop Recording",
    "voiceNotes.talkNote": "Talk Note",
    "voiceNotes.transcriptLabel": "Transcript",
    "voiceNotes.listeningPrefix": "Listening: ",
    "voiceNotes.draftKicker": "AI Note Draft",
    "voiceNotes.keyPoints": "Key Points",
    "voiceNotes.fuzzyPoints": "What Still Feels Fuzzy",
    "voiceNotes.alreadyClear": "AI thinks your explanation is already fairly clear.",
    "voiceNotes.nextAction": "Next Action",
    "voiceNotes.step2Label": "2. Answer the follow-up questions",
    "voiceNotes.step2Desc": "If you do not want to type, click the mic beside a question and answer it out loud.",
    "voiceNotes.nextPrefix": "Next:",
  ...
  zh: {
    ...
    "practice.generateErrRate": "请求太频繁，稍等片刻再试",
    "practice.generateErrNone": "未找到课程大纲，请先设置课程内容",
    "practice.generateErrFail": "生成失败，请重试",
    ...
    "settings.reviewRetention": "间隔重复目标记忆率",
    "settings.reviewRetentionDesc": "每张卡片被认为已掌握前的目标记忆率。越低 = 复习次数越少，记忆率略低。",
    ...
    "settings.passwordPlaceholder": "新密码（至少 6 位）",
    "settings.semesterPlaceholder": "例如：2026 春季学期",
    "settings.modelNote": "AI 模型由管理员统一配置。",
    "settings.aboutTitle": "关于 CourseHub",
    "settings.aboutVersion": "版本：",
    "settings.aboutStack": "技术栈：",
    "settings.aboutAI": "AI 模型：",
    "settings.aboutStorage": "存储：",
    "settings.aboutDesc": "CourseHub 将你的课程大纲转化为结构化学习系统——大纲、学习任务、练习题和掌握度追踪。为想要高效学习的学生而生。",
    ...
    "review.nextDueToday": "下次复习在 {hours} 小时后",
    "review.nextDueTomorrow": "下次复习在明天",
    "review.nextDueFuture": "下次复习在 {days} 天后",
    ...
    "review.scopeNoMatch": "未找到匹配主题，请换个说法再试。",
    "review.scopeError": "匹配失败，请重试。",
    "review.toReview": "需复习",
    ...
    "practice.shuffle": "随机打乱题目",
    "practice.bookmarkFilter": "只看已收藏",
    "practice.noBookmarkedQuestions": "暂无收藏题目",
    "practice.noBookmarkedQuestionsDesc": "答题时点击收藏按钮，可创建专属练习集。",
    ...
    "voiceNotes.step1Label": "1. 说话或粘贴原始笔记",
    "voiceNotes.step1Desc": "用麦克风录制主笔记，如果 AI 询问你澄清问题，再使用下方的小麦克风按钮。",
    "voiceNotes.stopRecording": "停止录音",
    "voiceNotes.talkNote": "语音记录",
    "voiceNotes.transcriptLabel": "转录文本",
    "voiceNotes.listeningPrefix": "正在聆听：",
    "voiceNotes.draftKicker": "AI 笔记草稿",
    "voiceNotes.keyPoints": "关键要点",
    "voiceNotes.fuzzyPoints": "仍感模糊的地方",
    "voiceNotes.alreadyClear": "AI 认为你的解释已经相当清晰。",
    "voiceNotes.nextAction": "下一步行动",
    "voiceNotes.step2Label": "2. 回答跟进问题",
    "voiceNotes.step2Desc": "如果不想打字，点击问题旁边的麦克风大声回答。",
    "voiceNotes.nextPrefix": "下一步：",
