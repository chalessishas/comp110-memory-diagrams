...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "profile.metacognitionDesc": "Self-assessment matched reality",
    "profile.weekSummary": "This Week",
    "profile.questionsAnswered": "Questions Answered",
    "profile.conceptsProficient": "Concepts Proficient+",
    "profile.level.unseen": "Unseen",
    "profile.level.exposed": "Exposed",
    "profile.level.practiced": "Practiced",
    "profile.level.proficient": "Proficient",
    "profile.level.mastered": "Mastered",
    ...
    "learn.loadFailed": "Lesson content failed to load. Please try again.",
    "learn.complete": "Lesson Complete!",
    "learn.completeDesc": "Well done. You've completed this lesson.",
    "learn.generatingSection": "Generating next section...",
    "learn.pretestHint": "Try first — getting it wrong is fine, the attempt itself helps you learn",
    "learn.fillBlank": "Fill in the blank...",
    "learn.typeAnswer": "Type your answer...",
    "learn.check": "Check",
    "learn.skipMoveOn": "Skip, move on",
    "learn.correct": "Correct",
    "learn.expectedAnswer": "Expected answer:",
    "learn.gotItRight": "I got it right",
    "learn.needReview": "I need to review",
    "learn.notQuite": "Not quite",
    "learn.keepGoing": "That's okay. Keep going — this topic will come back in review.",
    "learn.nowLearn": "Now let's learn",
    "learn.finish": "Finish",
    ...
    "library.confirmDelete": "Delete this file?",

    // Notes
    "notes.saved": "Note saved to this course.",
    ...
    "settings.confirmDeleteAccount": "Delete your account and ALL data? This cannot be undone.",
    "settings.confirmDeleteFinal": "Are you absolutely sure? All courses, questions, and progress will be permanently deleted.",
    ...
    "settings.aiModelManaged": "Model selection is managed by the administrator.",
    ...
    // Courses
    "courses.confirmDelete": "Delete this course and all its data?",
    "courses.archive": "Archive",
    "courses.restore": "Restore",
    ...
    "review.examMode": "Exam Mode",
    "review.daysUntilExam": "day(s)",
    "review.weakestFirst": "weakest first",
    "review.turnOff": "Turn off",
    "review.setExamDate": "Set exam date for intensive review mode",
    "review.cancel": "Cancel",
    "review.examScope": "Exam Scope",
    "review.knowledgePoints": "knowledge point(s)",
    "review.clearScope": "Clear scope",
    "review.setScopeDesc": "Set exam scope to focus review on tested material",
    "review.scopePrompt": "Paste exam scope (e.g., Chapters 8-10, convergence tests, Taylor series)",
    "review.scopePlaceholder": "Type or paste exam scope...",
    "review.matchKp": "Match knowledge points",
    "review.toReview": "to review",
    "review.examDayRecall": "Exam day recall",
  ...
  zh: {
    ...
    // Profile View
    "profile.title": "掌握度画像",
    "profile.overview": "掌握度概览",
    "profile.mastered": "已掌握",
    "profile.weaknesses": "持续性弱点",
    "profile.occurred": "出现",
    "profile.times": "次",
    "profile.relapsed": "已复发",
    "profile.resolved": "已克服",
    "profile.metacognition": "元认知准确度",
    "profile.metacognitionDesc": "元认知准确度",
    "profile.weekSummary": "本周学习",
    "profile.questionsAnswered": "答题次数",
    "profile.conceptsProficient": "掌握的知识点",
    "profile.level.unseen": "未接触",
    "profile.level.exposed": "已接触",
    "profile.level.practiced": "已练习",
    "profile.level.proficient": "已熟练",
    "profile.level.mastered": "已掌握",
    ...
    "learn.previous": "上一课",
    "learn.next": "下一课",
    "learn.loadFailed": "课程内容加载失败，请重试。",
    "learn.complete": "课程完成！",
    "learn.completeDesc": "做得好。这节课的内容已经学完了。",
    "learn.generatingSection": "正在生成下一个教学环节...",
    "learn.pretestHint": "先试试看——答错没关系，尝试本身就能帮助学习",
    "learn.fillBlank": "填写答案...",
    "learn.typeAnswer": "输入你的答案...",
    "learn.check": "提交",
    "learn.skipMoveOn": "跳过，继续",
    "learn.correct": "正确",
    "learn.expectedAnswer": "参考答案：",
    "learn.gotItRight": "我答对了",
    "learn.needReview": "我需要复习",
    "learn.notQuite": "不太对",
    "learn.keepGoing": "没关系，继续前进。这个知识点会在后续复习中重新出现。",
    "learn.nowLearn": "现在来学习",
    "learn.finish": "完成",
    "learn.continue": "继续",

    // Learning Blueprint
    "blueprint.kicker": "学习流程",
    "blueprint.emptyTitle": "从大纲开始学习。",
    "blueprint.emptyDesc": "课程有了大纲节点、任务和题目后，这个页面会把它们组织成具体的学习路径。",
    "blueprint.title": "不只是看大纲，要真正学起来。",
    "blueprint.desc": "每个知识点变成一个小循环：学概念、做练习、复习错题，然后进入下一个。",
    "blueprint.openPractice": "打开练习",
    "blueprint.startHere": "从这里开始",
    "blueprint.step": "步骤",
    "blueprint.noAttempts": "暂无做题记录",
    "blueprint.correct": "正确率",
    ...
    "library.confirmDelete": "删除此文件？",

    // Notes
    "notes.saved": "笔记已保存到本课程。",
    ...
    "settings.confirmClearStudy": "清除所有学习时间数据？此操作不可撤销。",
    "settings.confirmClearReview": "清除所有间隔复习进度？此操作不可撤销。",
    "settings.confirmDeleteAccount": "删除你的账号和所有数据？此操作不可撤销。",
    "settings.confirmDeleteFinal": "你确定吗？所有课程、题目和学习进度将被永久删除。",
    "settings.namePlaceholder": "你的名字",
    "settings.passwordPlaceholder": "新密码（至少 6 个字符）",
    "settings.semesterPlaceholder": "例如 2026 秋季",
    "settings.aiModelManaged": "AI 模型由管理员管理。",
    "settings.aboutTitle": "关于 CourseHub",
    "settings.version": "版本",
    "settings.stack": "技术栈",
    "settings.storage": "存储",
    "settings.aboutDesc": "CourseHub 将你的课程大纲转化为结构化学习系统 — 大纲、学习任务、练习题和掌握度追踪。为想要高效学习的学生而建。",

    // Courses
    "courses.confirmDelete": "删除此课程及其所有数据？",
    "courses.archive": "归档",
    "courses.restore": "恢复",
    "courses.delete": "删除",
    ...
    "review.examMode": "考试模式",
    "review.daysUntilExam": "天后考试",
    "review.weakestFirst": "按薄弱程度排序",
    "review.turnOff": "关闭",
    "review.setExamDate": "设置考试日期，启用高强度复习",
    "review.cancel": "取消",
    "review.examScope": "考试范围",
    "review.knowledgePoints": "个知识点",
    "review.clearScope": "清除范围",
    "review.setScopeDesc": "设置考试范围，只复习考试内容",
    "review.scopePrompt": "粘贴考试范围（如：Chapters 8-10, 级数判别法, Taylor 展开）",
    "review.scopePlaceholder": "输入或粘贴考试范围...",
    "review.matchKp": "匹配知识点",
    "review.toReview": "需复习",
    "review.examDayRecall": "考试日记忆率",
