from data.characters.lessng import make_lessng, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_lessng_s1_config():
    op = make_lessng(slot="S1")
    sk = op.skill
...
def test_lessng_s2_config():
    op = make_lessng(slot="S2")
    sk = op.skill
...
def test_lessng_s3_config():
    op = make_lessng(slot="S3")
    sk = op.skill
