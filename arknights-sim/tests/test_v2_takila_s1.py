...
from data.characters.takila import make_takila, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_takila_s1_config():
    op = make_takila(slot="S1")
    sk = op.skill
...
def test_takila_s2_config():
    op = make_takila(slot="S2")
    sk = op.skill
...
def test_takila_s3_config():
    op = make_takila(slot="S3")
    sk = op.skill
