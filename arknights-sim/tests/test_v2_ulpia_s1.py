...
from data.characters.ulpia import make_ulpia, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_ulpia_s1_config():
    op = make_ulpia(slot="S1")
    sk = op.skill
...
def test_ulpia_s2_config():
    op = make_ulpia(slot="S2")
    sk = op.skill
...
def test_ulpia_s3_config():
    op = make_ulpia(slot="S3")
    sk = op.skill
