"""Nowell S1 "Keep Moving" — 30s MANUAL, ATK+40%, ASPD+40.
...
from data.characters.nowell import (
    make_nowell,
...
def test_nowell_s1_config():
    op = make_nowell(slot="S1")
    sk = op.skill
    assert sk is not None and sk.slot == "S1"
    assert sk.name == "Keep Moving"
