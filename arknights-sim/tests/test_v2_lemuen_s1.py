from data.characters.lemuen import make_lemuen, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_lemuen_s1_config():
    op = make_lemuen(slot="S1")
    sk = op.skill
...
def test_lemuen_s2_config():
    op = make_lemuen(slot="S2")
    sk = op.skill
...
def test_lemuen_s3_config():
    op = make_lemuen(slot="S3")
    sk = op.skill
