from data.characters.morgan import make_morgan, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION
...
def test_morgan_s3_config():
    op = make_morgan(slot="S3")
    sk = op.skill
