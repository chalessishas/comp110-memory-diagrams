...
from data.characters.zebra import make_zebra, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION
...
def test_zebra_s3_config():
    op = make_zebra(slot="S3")
    sk = op.skill
