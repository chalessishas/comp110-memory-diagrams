"""Peper S2 "Cover Operations" — 30s MANUAL, ASPD+85.

Tests cover:
  - S1 config (stub: sp_cost=9, initial_sp=0)
  - S2 config (sp_cost=30, initial_sp=20, duration=30s)
...
from data.characters.peper import (
    make_peper,
