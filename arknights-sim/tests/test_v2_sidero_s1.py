...
from data.characters.sidero import make_sidero, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_sidero_s1_config():
    op = make_sidero(slot="S1")
    sk = op.skill
...
def test_sidero_s2_config():
    op = make_sidero(slot="S2")
    sk = op.skill
...
def test_sidero_s3_config():
    op = make_sidero(slot="S3")
    sk = op.skill
