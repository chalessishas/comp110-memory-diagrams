from data.characters.liesel import make_liesel, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_liesel_s1_config():
    op = make_liesel(slot="S1")
    sk = op.skill
...
def test_liesel_s2_config():
    op = make_liesel(slot="S2")
    sk = op.skill
...
def test_liesel_s3_config():
    op = make_liesel(slot="S3")
    sk = op.skill
