"""Lasher S1 "Wind Up" — 10s MANUAL, ASPD+60.

Tests cover:
  - S1 config (sp_cost=30, initial_sp=20, duration=10s)
...
from data.characters.lasher import (
    make_lasher,
...
def test_lasher_s1_config():
    op = make_lasher(slot="S1")
    sk = op.skill
