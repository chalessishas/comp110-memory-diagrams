"""Haruka S1 "Twilight Feathers" — 20s MANUAL, ASPD+60.

Tests cover:
  - S1 config (sp_cost=25, initial_sp=15, duration=20s)
...
from data.characters.haruka import (
    make_haruka,
...
def test_haruka_s1_config():
    ...
    assert sk.name == "Twilight Feathers"
