"""Platinum S1 "ATK Up γ" — 30s MANUAL, ATK+100%.
...
from data.characters.platnm import (
    make_platnm, _S1_TAG, _S1_ATK_RATIO, _S1_BUFF_TAG, _S1_DURATION,
)
...
def test_s2_regression():
    ...
    assert op.skill.name == "Pegasus Vision"
