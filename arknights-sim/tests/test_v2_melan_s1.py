"""Melan (Melantha) S1 "ATK Up α" — 20s MANUAL, ATK+50%.
...
from data.characters.melan import make_melan, _S1_TAG, _S1_ATK_RATIO, _S1_BUFF_TAG, _S1_DURATION
...
def test_melan_s1_config():
    op = make_melan(slot="S1")
    sk = op.skill
