"""Popka (Popukar) S1 "ATK Up α" — 20s MANUAL, ATK+50%.
...
from data.characters.popka import make_popka, _S1_TAG, _S1_ATK_RATIO, _S1_BUFF_TAG, _S1_DURATION
...
def test_popka_s1_config():
    op = make_popka(slot="S1")
    sk = op.skill
