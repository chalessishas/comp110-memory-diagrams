...
from data.characters.ray import make_ray, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_ray_s1_config():
    op = make_ray(slot="S1")
    sk = op.skill
