"""Penance (nearl2) S2 Disciplina — ATK+80% for 25s, no block change."""
...
from data.characters.nearl2 import (
    make_penance, _S2_TAG, _S2_ATK_RATIO, _S2_BUFF_TAG, _S2_DURATION,
)
...
def test_s2_atk_buff():
    ...
    buff = next((b for b in p.buffs if b.source_tag == _S2_BUFF_TAG), None)
