from data.characters.moeshd import make_moeshd, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_moeshd_s1_config():
    op = make_moeshd(slot="S1")
    sk = op.skill
...
def test_moeshd_s2_config():
    op = make_moeshd(slot="S2")
    sk = op.skill
...
def test_moeshd_s3_config():
    op = make_moeshd(slot="S3")
    sk = op.skill
