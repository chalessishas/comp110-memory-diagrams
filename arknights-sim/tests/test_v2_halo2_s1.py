"""Halo Alter (halo2) S1/S2/S3 — all stub skills."""
from __future__ import annotations
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))
from data.characters.halo2 import make_halo2, _S1_TAG, _S1_DURATION, _S2_TAG, _S3_TAG

def test_halo2_s1_config():
    op = make_halo2(slot="S1")
    sk = op.skill
