"""Silent S1 "Healing Enhancement γ" — 30s MANUAL, ATK+90%.
...
from data.characters.silent import (
    make_silent,
...
def test_silent_s1_config():
    op = make_silent(slot="S1")
    sk = op.skill
