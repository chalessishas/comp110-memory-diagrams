from data.characters.mizuki import make_mizuki, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_mizuki_s1_config():
    op = make_mizuki(slot="S1")
    sk = op.skill
...
def test_mizuki_s2_config():
    op = make_mizuki(slot="S2")
    sk = op.skill
...
def test_mizuki_s3_config():
    op = make_mizuki(slot="S3")
    sk = op.skill
