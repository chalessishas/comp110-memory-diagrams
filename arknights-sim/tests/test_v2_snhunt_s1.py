...
from data.characters.snhunt import make_snhunt, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_snhunt_s1_config():
    op = make_snhunt(slot="S1")
    sk = op.skill
...
def test_snhunt_s2_config():
    op = make_snhunt(slot="S2")
    sk = op.skill
...
def test_snhunt_s3_config():
    op = make_snhunt(slot="S3")
    sk = op.skill
