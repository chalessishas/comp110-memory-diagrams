"""Slent2 S1 "Pioneering Spirit" — 25s MANUAL, ATK+80%.

Tests cover:
  - S1 config (sp_cost=30, initial_sp=15, duration=25s)
...
from data.characters.slent2 import (
    make_slent2,
...
def test_slent2_s1_config():
    op = make_slent2(slot="S1")
    sk = op.skill
