"""Orchid S1 "Swift Strike α" — 25s MANUAL, ATK+25% ASPD+25.
...
from data.characters.orchid import (
    make_orchid, _S1_TAG, _S1_ATK_RATIO, _S1_ASPD_BONUS,
...
def test_orchid_s1_config():
    op = make_orchid(slot="S1")
    sk = op.skill
