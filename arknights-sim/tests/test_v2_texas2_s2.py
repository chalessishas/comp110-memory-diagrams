"""Texas Alter S2 Gale Rush — ATK+100% for 15s."""
...
from data.characters.texas2 import (
    make_texas_alter, _S2_TAG, _S2_ATK_RATIO, _S2_BUFF_TAG, _S2_DURATION,
)
...
def test_texas_alter_s2_config():
    t = make_texas_alter(slot="S2")
    sk = t.skill
    assert sk is not None and sk.slot == "S2"
    assert sk.name == "Gale Rush"
...
def test_s2_atk_buff():
    ...
    buff = next((b for b in t.buffs if b.source_tag == _S2_BUFF_TAG), None)
