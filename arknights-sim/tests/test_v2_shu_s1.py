...
from data.characters.shu import make_shu, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_shu_s1_config():
    op = make_shu(slot="S1")
    sk = op.skill
