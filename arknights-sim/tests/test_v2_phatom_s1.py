from data.characters.phatom import make_phatom, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_phatom_s1_config():
    op = make_phatom(slot="S1")
    sk = op.skill
...
def test_phatom_s2_config():
    op = make_phatom(slot="S2")
    sk = op.skill
...
def test_phatom_s3_config():
    op = make_phatom(slot="S3")
    sk = op.skill
