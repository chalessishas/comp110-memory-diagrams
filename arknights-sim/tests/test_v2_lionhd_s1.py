from data.characters.lionhd import make_lionhd, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_lionhd_s1_config():
    op = make_lionhd(slot="S1")
    sk = op.skill
...
def test_lionhd_s2_config():
    op = make_lionhd(slot="S2")
    sk = op.skill
...
def test_lionhd_s3_config():
    op = make_lionhd(slot="S3")
    sk = op.skill
