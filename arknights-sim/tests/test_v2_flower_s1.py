"""Flower S2 "Healing Enhancement β" — 25s MANUAL, ATK+70%.
...
from data.characters.flower import (
    make_flower,
...
def test_flower_s1_config():
    op = make_flower(slot="S1")
    sk = op.skill
...
def test_flower_s2_config():
    op = make_flower(slot="S2")
    sk = op.skill
