...
from data.characters.swire2 import make_swire2, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION


def test_swire2_s1_config():
    op = make_swire2(slot="S1")
    sk = op.skill
...
def test_swire2_s2_config():
    op = make_swire2(slot="S2")
    sk = op.skill
...
def test_swire2_s3_config():
    op = make_swire2(slot="S3")
    sk = op.skill
