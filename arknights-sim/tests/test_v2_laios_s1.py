from data.characters.laios import make_laios, _S1_TAG, _S1_DURATION, _S2_TAG, _S2_DURATION, _S3_TAG, _S3_DURATION
...
def test_laios_s3_config():
    op = make_laios(slot="S3")
    sk = op.skill
