"""Sleach (Silver Lance) — 4★ Vanguard (Charger).
...
from data.characters.generated.sleach import make_sleach as _base_stats

VAN_RANGE = RangeShape(tiles=((0, 0), (1, 0)))
_S1_TAG = "sleach_s1"; _S1_DURATION = 0.0
_S2_TAG = "sleach_s2"; _S2_DURATION = 15.0

def make_sleach(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Sleach"
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Sleach S1", slot="S1", sp_cost=0, initial_sp=0,
        ...
        op.skill = SkillComponent(name="Sleach S2", slot="S2", sp_cost=25, initial_sp=12,
