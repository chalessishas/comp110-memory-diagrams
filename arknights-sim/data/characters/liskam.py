"""Liskam (char) — 5★ Defender (Protector).
...
_S1_TAG = "liskam_s1"; _S1_DURATION = 0.0
_S2_TAG = "liskam_s2"; _S2_DURATION = 30.0
...
def make_liskam(slot: str = "S2") -> UnitState:
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Liskam S1", slot="S1", sp_cost=5, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Liskam S2", slot="S2", sp_cost=55, initial_sp=28,
