...
_S1_TAG = "swire_s1"; _S1_DURATION = 0.0
_S2_TAG = "swire_s2"; _S2_DURATION = 20.0
...
def make_swire(slot: str = "S2") -> UnitState:
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Swire S1", slot="S1", sp_cost=5, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_ATTACK,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Swire S2", slot="S2", sp_cost=35, initial_sp=18,
