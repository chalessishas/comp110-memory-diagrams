"""Pudding (布丁) — 4★ Caster (Core).

S1 "Tactical Chant β" (shared skcom_magic_rage[2]):
  sp_cost=35, initial_sp=10, duration=25s, MANUAL, AUTO_TIME.
  ASPD +75.

S2 "Diffusion Current": sp_cost=35, initial_sp=20, duration=20s, MANUAL, AUTO_TIME.
  ATK+110% + hits up to 4 targets (complex — not modeled).
"""
...
from data.characters.generated.pudd import make_pudd as _base_stats
...
_S1_TAG = "pudd_s1_tactical_chant"
_S1_ASPD_BONUS = 75.0
_S1_ASPD_BUFF_TAG = "pudd_s1_aspd"
_S1_DURATION = 25.0
_S2_TAG = "pudd_s2_diffusion_current"
_S2_DURATION = 20.0
...
def _s1_on_start(world, carrier: UnitState) -> None:
    ...
    world.log(f"Pudd S1 — ASPD+{_S1_ASPD_BONUS:.0f}/{_S1_DURATION}s")
...
def make_pudd(slot: str = "S1") -> UnitState:
    op = _base_stats()
    op.name = "Pudd"
    ...
    if slot == "S1":
        ...
        op.skill = SkillComponent(
            name="Diffusion Current", slot="S2", sp_cost=35, initial_sp=20,
