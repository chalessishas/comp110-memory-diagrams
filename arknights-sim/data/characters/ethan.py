...
Talent "Neurotoxin": each normal attack applies ATK_DOWN (flat -200 ATK)
  to the target for 2s. Refresh semantics. Introduces the first ATK_DOWN
  status+buff pair — enemies hit by Ethan deal less damage to operators they
  block, because effective_atk uses the debuffed ATK value.
