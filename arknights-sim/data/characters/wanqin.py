...
from data.characters.generated.wanqin import make_wanqin as _base_stats

OP_RANGE = RangeShape(tiles=((0, 0), (1, 0)))
_S1_TAG = "wanqin_s1"; _S1_DURATION = 0.0
_S2_TAG = "wanqin_s2"; _S2_DURATION = 15.0

def make_wanqin(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Wanqin"
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Wanqin S1", slot="S1", sp_cost=0, initial_sp=0,
        ...
        op.skill = SkillComponent(name="Wanqin S2", slot="S2", sp_cost=25, initial_sp=12,
