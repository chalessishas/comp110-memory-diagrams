"""Cetsyr (魔王) — Supporter (char_4134).

S1: sp_cost=20, initial_sp=10, duration=10s, AUTO_TIME, MANUAL (stub).
S2: sp_cost=45, initial_sp=25, duration=20s, AUTO_TIME, MANUAL (stub).
"""
...
def make_cetsyr(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Cetsyr"
    ...
    if slot == "S1":
        op.skill = SkillComponent(
            name="Cetsyr S1", slot="S1", sp_cost=20, initial_sp=10,
