"""Slent2 (Silence alter 寂静) — 5★ Supporter (Decel).
...
_S1_TAG = "slent2_s1"; _S1_DURATION = 0.0
_S2_TAG = "slent2_s2"; _S2_DURATION = 10.0

def make_slent2(slot: str = "S2") -> UnitState:
    op = _base_stats()
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Silence the Paradigmatic S1", slot="S1", sp_cost=15, initial_sp=8,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.AUTO, requires_target=False, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Silence the Paradigmatic S2", slot="S2", sp_cost=30, initial_sp=15,
