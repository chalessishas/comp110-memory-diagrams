...
from data.characters.generated.puzzle import make_puzzle as _base_stats

VAN_RANGE = RangeShape(tiles=((0, 0), (1, 0)))
_S1_TAG = "puzzle_s1"; _S1_DURATION = 0.0
_S2_TAG = "puzzle_s2"; _S2_DURATION = 15.0

def make_puzzle(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Puzzle"
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Puzzle S1", slot="S1", sp_cost=0, initial_sp=0,
        ...
        op.skill = SkillComponent(name="Puzzle S2", slot="S2", sp_cost=25, initial_sp=12,
