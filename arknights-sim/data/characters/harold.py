...
S2: sp_cost=35, initial_sp=17, duration=20s, AUTO_TIME, MANUAL (stub).
"""
...
_S1_TAG = "harold_s1"; _S1_DURATION = 0.0
_S2_TAG = "harold_s2"; _S2_DURATION = 20.0

def make_harold(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Harold"
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Harold S1", slot="S1", sp_cost=5, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Harold S2", slot="S2", sp_cost=35, initial_sp=17,
