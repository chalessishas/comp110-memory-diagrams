...
from data.characters.generated.melan import make_melan as _base_stats

MELEE_RANGE = RangeShape(tiles=((0, 0),))

_S1_TAG = "melan_s1_atk_up"
_S1_ATK_RATIO = 0.50
_S1_BUFF_TAG = "melan_s1_atk"
_S1_DURATION = 20.0
...
def _s1_on_start(world, carrier: UnitState) -> None:
    ...
    world.log(f"Melan S1 — ATK+{_S1_ATK_RATIO:.0%}/{_S1_DURATION}s")
...
def make_melan(slot: str = "S1") -> UnitState:
    op = _base_stats()
    op.name = "Melan"
