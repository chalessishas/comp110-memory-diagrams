...
_S1_TAG = "mitm_s1"; _S1_DURATION = 20.0
_S2_TAG = "mitm_s2"; _S2_DURATION = 25.0
...
def make_mitm(slot: str = "S2") -> UnitState:
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Mitm S1", slot="S1", sp_cost=0, initial_sp=0,
        ...
        op.skill = SkillComponent(name="Mitm S2", slot="S2", sp_cost=30, initial_sp=15,
