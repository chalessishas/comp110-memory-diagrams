"""Aosta (Aosta) — 5★ Sniper (Marksman).

S1 "Swift Strike γ" (shared): sp_cost=35, initial_sp=15, duration=35s, MANUAL, AUTO_TIME.
  ATK +45%, ASPD +45.

S2 "Shadow Nails": sp_cost=50, initial_sp=25, duration=25s, MANUAL, AUTO_TIME.
  ATK+70% + frozen on hit + base_attack_time+0.5s (complex — not modeled).
"""
...
from data.characters.generated.aosta import make_aosta as _base_stats
...
_S1_TAG = "aosta_s1_swift_strike"
_S1_ATK_RATIO = 0.45
_S1_ASPD_BONUS = 45.0
_S1_ATK_BUFF_TAG = "aosta_s1_atk"
_S1_ASPD_BUFF_TAG = "aosta_s1_aspd"
_S1_DURATION = 35.0
_S2_TAG = "aosta_s2_shadow_nails"
_S2_DURATION = 25.0
...
def _s1_on_start(world, carrier: UnitState) -> None:
    ...
    world.log(f"Aosta S1 — ATK+{_S1_ATK_RATIO:.0%} ASPD+{_S1_ASPD_BONUS:.0f}/{_S1_DURATION}s")
...
def make_aosta(slot: str = "S1") -> UnitState:
    op = _base_stats()
    op.name = "Aosta"
    ...
    if slot == "S1":
        ...
        op.skill = SkillComponent(
            name="Shadow Nails", slot="S2", sp_cost=50, initial_sp=25,
