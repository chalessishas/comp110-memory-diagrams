...
S2 "Venom Spray": sp_cost=50, initial_sp=20, duration=26s, MANUAL, AUTO_TIME.
  ATK +30% (multi-target component not modeled).
"""
...
def make_bluep(slot: str = "S2") -> UnitState:
    ...
    if slot == "S1":
        ...
        op.skill = SkillComponent(
            name="Venom Spray", slot="S2", sp_cost=50, initial_sp=20,
