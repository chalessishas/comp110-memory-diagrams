...
_S2_TAG = "lessng_s2"; _S2_DURATION = 30.0
_S3_TAG = "lessng_s3"; _S3_DURATION = 35.0
...
def make_lessng(slot: str = "S3") -> UnitState:
    ...
    if slot == "S1":
        ...
        op.skill = SkillComponent(name="Lessing S2", slot="S2", sp_cost=50, initial_sp=25,
            duration=_S2_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.MANUAL, requires_target=False, behavior_tag=_S2_TAG)
    elif slot == "S3":
        op.skill = SkillComponent(name="Lessing S3", slot="S3", sp_cost=65, initial_sp=32,
