...
_S1_TAG = "haruka_s1"; _S1_DURATION = 10.0
_S2_TAG = "haruka_s2"; _S2_DURATION = 20.0

def make_haruka(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Haruka"
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Haruka S1", slot="S1", sp_cost=20, initial_sp=10,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.MANUAL, requires_target=False, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Haruka S2", slot="S2", sp_cost=45, initial_sp=22,
