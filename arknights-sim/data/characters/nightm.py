...
_S1_TAG = "nightm_s1"; _S1_DURATION = 0.0
_S2_TAG = "nightm_s2"; _S2_DURATION = 15.0

def make_nightm(slot: str = "S2") -> UnitState:
    op = _base_stats()
    op.name = "Nightm"
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Nightm S1", slot="S1", sp_cost=10, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Nightm S2", slot="S2", sp_cost=30, initial_sp=15,
