...
_S1_TAG = "highmo_s1"; _S1_DURATION = 0.0
_S2_TAG = "highmo_s2"; _S2_DURATION = 20.0
...
def make_highmo(slot: str = "S2") -> UnitState:
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Highmore S1", slot="S1", sp_cost=3, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_ATTACK,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Highmore S2", slot="S2", sp_cost=40, initial_sp=20,
