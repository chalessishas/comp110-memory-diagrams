"""Mudrock (泥岩) — 6★ Defender (Protector).
...
_S1_TAG = "mudrok_s1"; _S1_DURATION = 0.0
_S2_TAG = "mudrok_s2"; _S2_DURATION = 30.0
_S3_TAG = "mudrok_s3"; _S3_DURATION = 35.0
...
def make_mudrok(slot: str = "S3") -> UnitState:
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Mudrock S1", slot="S1", sp_cost=5, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Mudrock S2", slot="S2", sp_cost=50, initial_sp=25,
            duration=_S2_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.MANUAL, requires_target=False, behavior_tag=_S2_TAG)
    elif slot == "S3":
        op.skill = SkillComponent(name="Mudrock S3", slot="S3", sp_cost=65, initial_sp=32,
