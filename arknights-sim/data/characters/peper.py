...
_S1_TAG = "peper_s1"; _S1_DURATION = 0.0
_S2_TAG = "peper_s2"; _S2_DURATION = 25.0
...
def make_peper(slot: str = "S2") -> UnitState:
    ...
    if slot == "S1":
        op.skill = SkillComponent(name="Peper S1", slot="S1", sp_cost=9, initial_sp=0,
            duration=_S1_DURATION, sp_gain_mode=SPGainMode.AUTO_TIME,
            trigger=SkillTrigger.AUTO, requires_target=True, behavior_tag=_S1_TAG)
    elif slot == "S2":
        op.skill = SkillComponent(name="Peper S2", slot="S2", sp_cost=40, initial_sp=20,
